  ...
  return (
    <div ref={searchRef} className="relative w-32 sm:w-40 md:w-[300px]">
      <input
        ...
        className="w-full rounded text-sm px-3 py-1 pr-10 bg-white/50 text-gray-900 outline-none focus:bg-white/70 transition-colors"
      />
              ...
              {userResults.length > 0 && (
                <>
                  ...
                  {userResults.map((result) => (
                    ...
                    >
                      <img src={playerIcon} alt="Player" className="w-5 h-5" />
              ...
              {gameResults.length > 0 && (
                <>
                  ...
                  {gameResults.map((result) => (
                    ...
                    >
                      <img src={gameIcon} alt="Game" className="w-5 h-5" />
                      <span className="text-sm text-gray-900">
                        {result.name}
                      </span>
                    </button>
